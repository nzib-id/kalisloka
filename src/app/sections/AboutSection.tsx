  ...
  return (
    <section id="about" className="relative w-full pb-20">
      ...
      >
        ...
        <div className="max-w-[830px] mx-auto px-7 md:px-10 text-justify tracking-tight">
          {/* LOGO */}
          <div className="flex justify-center mb-12 md:mb-16 pt-20 md:pt-10">
            <img
              src="/images/logo.svg"
              alt="Kalisloka"
          ...
          <p className="text-[15px] md:text-[17px] leading-[1.75] mb-5 md:mb-7">
            <span className="font-bold">Kalisloka</span> is a B2B agricultural
            raw material supply and trade partner operating with a
            portfolio-based product approach. We focus on clarity, consistency,
            and practical cooperation for commercial buyers in the food, herbal,
            hospitality, and packaging industries.
          </p>
          ...
          <a
            ...
            className="
              ...
              text-lg
              text-[#004035]
              hover:opacity-70 transition tracking-wider
            "
          >
